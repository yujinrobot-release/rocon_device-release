## rocon_devices (indigo) - 0.0.7-0

The packages in the `rocon_devices` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rocon_devices -t indigo -r indigo` on `Tue, 28 Jul 2015 08:38:12 -0000`
