Name:           ros-indigo-rocon-rtsp-camera-relay
Version:        0.0.5
Release:        0%{?dist}
Summary:        ROS rocon_rtsp_camera_relay package
...
%description
RTSP camera relay node converts rtsp camera stream from ip camera to ros image
message
